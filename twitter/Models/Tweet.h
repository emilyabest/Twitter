...
@property (nonatomic) int retweetCount; // Updater favorite count label
...
@property (strong, nonatomic) User *retweetedByUser; // User who retweeted if tweet is retweet; for re-tweets
